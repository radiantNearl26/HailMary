...
import { addSubscription, type Subscription } from "@/lib/subscriptions";
...
interface AddSubscriptionDialogProps {
  ...
  showTrigger?: boolean;
  onSubscriptionAdded?: (updated: Subscription[]) => void;
}
...
export default function AddSubscriptionDialog({
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const updated = addSubscription(newSub);
      setOpen?.(false);
      onSubscriptionAdded?.(updated);
          ...
          <div className="flex flex-col-reverse md:flex-row">
              ...
              <div className="flex-1 grow">
                <div className="border-t p-6 md:border-none">
                  ...
                  <p className="mt-1 text-sm leading-6 text-muted-foreground">
                    Fill in the subscription info to start tracking your billing
                    cycle and get timely reminders.
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 space-y-6 p-6 md:px-6 md:pb-8 md:pt-6">
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="Entertainment" name="category">
