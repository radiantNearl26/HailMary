...
const serviceIcons: Record<string, React.ReactNode> = {
  Netflix: (
    ...
    >
      <path
        fill="#E50914"
        d="M5.398 0v.006c3.028 8.556 5.37 15.175 8.348 23.596 2.344.058 4.85.398 4.854.398-2.8-7.924-5.923-16.747-8.487-24zm8.489 0v9.63L18.6 22.951c.043.007.295.058.399.078V0zM5.398 1.05V24c1.873-.225 2.81-.312 4.715-.398v-9.22z"
      />
    </svg>
  ),
  Spotify: (
